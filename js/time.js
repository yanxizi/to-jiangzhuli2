function showTime() { 
	...
	var startDate = new Date(2021, 01, 28);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear 蒋珠丽:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----谭朝全 2021-05-20</c>"; 
